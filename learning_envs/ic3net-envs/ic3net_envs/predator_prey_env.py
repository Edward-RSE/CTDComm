...
class PredatorPreyEnv(gym.Env):
    ...
    def _get_reward(self):
        ...
        # This doesn't work for multiple prey (args.nenemies != 1)
        #   I think it could work if you loop through prey here but you will need to
        #   change more below
        # print(self.predator_loc, self.prey_loc, self.predator_loc == self.prey_loc)
